 ...
 */
#define BABYSTEPPING  // LRW modified for CR-10s (uncommented)
#if ENABLED(BABYSTEPPING)
  //#define BABYSTEP_XY              // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false    // Change if Z babysteps should go the other way
  #define BABYSTEP_MULTIPLICATOR 5   // Babysteps are very small. Increase for faster motion. // LRW modified for CR-10s (1)
  //#define BABYSTEP_ZPROBE_OFFSET   // Enable to combine M851 and Babystepping
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING // Double-click on the Status Screen for Z Babystepping. // LRW modified for CR-10s (uncommented)
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT               // Disable this feature to save ~3226 bytes // LRW modified for CR-10s (commented)
 ...
 */
#define ADVANCED_PAUSE_FEATURE // LRW modified for CR-10s (uncommented)
...
//#define HAVE_TMC2208
   ...
   * In the case of overtemperature Marlin can decrease the driver curr2ent until error condition clears.
